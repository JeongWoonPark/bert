...
flags.DEFINE_string(
    ...
    " corresponding to the pre-trained BERT model. "
...
# if you download cased checkpoint you should use "False",if uncased you should use "True"
...
flags.DEFINE_bool("lstm", False, "use lstm!")
    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            train_op = optimization.create_optimizer(total_loss, learning_rate, num_train_steps, num_warmup_steps,
                                                     use_tpu)
            logging_hook = tf.train.LoggingTensorHook({"loss": total_loss}, every_n_iter=10)  # Add
    ...
    if FLAGS.do_predict:
        ...
        def serving_input_receiver_fn():
            ...
            features = {
                ...
                "mask": 1 - tf.cast(tf.equal(reciever_tensors['input_ids'], 0), dtype=tf.int64),
